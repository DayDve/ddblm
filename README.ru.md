...
Эти букмарклеты копились у меня годами — без великого плана, просто скрипты, которые
оказывались полезны. Часть из них про сайты, которые мешают: блокируют правый клик,
выделение или копирование, прячут пароли за звёздочками, отключают кнопки.
Другие — просто удобные штуки: QR-код на страницу, открыть её в Wayback Machine,
перегнать поиск в DuckDuckGo, отправить страницу в Telegram, поискать фильм по Кинопоиску.

Если сайт уж слишком мешает или понадобилось что-то одноразовое — просто пишу ещё один
букмарклет. Для этого и нужен хелпер `blm`.
