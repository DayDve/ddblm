...
Сайты постоянно мешают пользоваться собой: блокируют выделение и копирование, прячут
пароли за звёздочками, отключают кнопки, запрещают правый клик. А простые ежедневные
задачи — перегнать текущий поиск в DuckDuckGo, сделать QR на страницу, найти старую версию
в Web Archive — обычно означают хождение по сайтам или лишние расширения.

Эти букмарклеты решают повседневные задачи в один клик с панели закладок.
